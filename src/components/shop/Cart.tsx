...
export default function Cart() {
    return (
        <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-7">
                            ...
                            <div className="rounded-lg border border-[#451606]/40 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        <a href="#" className="text-base font-medium text-[#451606] hover:underline">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</a>
