        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-5">
                ...
                <div className="bg-cyan-950 opacity-[20px] text-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
                    ...
                    <a href="/checkout" className="block w-full py-3 px-6 text-center rounded-md text-white font-medium bg-transparent border border-white hover:bg-white hover:text-[#451606] hover:border hover-border-[#451606]">
                     Get Started
                    </a>
                </div>
                ...
                <div className="bg-emerald-600 opacity-[20px] text-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
                    ...
                    <a href="/checkout" className="block w-full py-3 px-6 text-center rounded-md text-white font-medium bg-transparent border border-white hover:bg-white hover:text-[#451606] hover:border hover-border-[#451606] font-medium0">
                        Get Started
                    </a>
                </div>
